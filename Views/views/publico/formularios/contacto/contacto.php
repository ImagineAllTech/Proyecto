    ...
    <main class="min-h-screen w-full flex items-center flex-col justify-between py-4">
        ...
        <img src="../../../../assets/img/Logotype.svg" class="w-12" alt="Logo">
            ...
            class="flex flex-col items-center justify-center w-full gap-8 w-full">
                ...
                <div class="form__container flex flex-col gap-20 w-9/12 md:w-5/12">
                    ...
                    <div class="form__group relative w-full">
                            <input type="email"
                            class="w-full bg-transparent border-b outline-none py-2 px-4 text-gray-900 font-bricolage text-xl border-blue-800 origin-top-left translate-y-3"
                            placeholder="Escribe la escuela aqui" name="Email"
                            pattern="[a-Z]{2,50}"
                            minlength="2" maxlenght="60" required>
                        <label for="Email" class="text-blue-700 font-bold font-bricolage absolute top-0 left-3 cursor-pointer px-1">Correo electronico</label>
                    </div>

                    <div class="form__group relative w-full">
                        <input type="text"
                        class="w-full bg-transparent border-b outline-none py-2 px-4 text-gray-900 font-bricolage text-xl border-blue-800 origin-top-left translate-y-3"
                        placeholder="Escribe el asunto aqui" name="Asunto"
                        pattern="[A-z]{2,20}"
                        minlength="2" maxlength="50" required
                        >
                        <label for="Asunto" class="text-blue-700 font-bold font-bricolage absolute top-0 left-3 cursor-pointer px-1">Asunto</label>
                    ...
                    <label for="Mensaje" class="text-blue-700 font-bold font-bricolage absolute top-0 bg-gray-200 left-3 cursor-pointer px-1">Mensaje</label>
                


                    <div class="buttons w-full h-24 flex items-center justify-center text-center">
                        <input type="submit" name="Enviar" class="w-full h-12 font-normal font-bricolage text-2xl rounded bg-blue-700 hover:bg-blue-800 text-white flex items-center justify-center text-center">
                    </div>
                    </div>
                </div>
            </div>            
        ...
        <?php
            ...
            include('../../../../../Controllers/enviarMail.php');
