...
<head>
    ...
    <title>CUKDash | Editar Competidor</title>
...
<body class="body flex flex-col justify-center items-end w-full min-h-screen font-montserrat">
   ...
   <div id="sidebar">
    ...
    <main id="main-content" class="p-8 lg:sidebar-activo mt-24 lg:mt-24 h-screen w-full flex flex-col items-center justify-start">
        ...
        <div class="mb-8">
            <h2 class="text-6xl text-blue-700 font-bold font-bricolage">Editar Competidor</h2>
        </div>
                ...
                <input type="hidden" id="ID" name="ID" value="<?php echo $data["ID"]; ?>" />
                    ...
                    <div class="form__group relative">
                        <input type="text"
						   ...
						   value="<?php echo $data["Competidores"]["CI"]?>"  
						   >
                     ...
                     <div class="flex gap-12 w-full">
                        <div class="form__group relative w-full">
							...
							value="<?php echo $data["Competidores"]["Nombre"]?>"
                            >
                        ...
                        <div class="form__group relative w-full">
                           <input type="text"
							  ...
							  value="<?php echo $data["Competidores"]["Apellido"]?>"
                              >
                     ...
                     <div class="form__group relative">
                        <input type="date"
						   ...
						   value="<?php echo $data["Competidores"]["Fnac"]?>"
						   >
                    ...
                    <div class="flex gap-12 w-full">
                        <div class="form__group relative w-full">
                            ...
                            pattern="[A-z]{2,50}"
							value="<?php echo $data["Competidores"]["Escuela"]?>"
                            minlength="2" maxlenght="50" required>
                        ...
                        <div class="form__group relative w-full">
                           <input type="text"
                              ...
                              pattern="[A-z]{2,50}"
							  value="<?php echo $data["Competidores"]["Dojo"]?>"
                              minlength="2" maxlenght="50" required>
