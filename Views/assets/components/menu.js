    ...
    <aside id="menuEntero" class="hidden lg:hidden fixed h-screen flex-col left-0 top-0 bg-slate-900 w-2/12 z-10 justify-between items-center">
        ...
        <div class="w-full flex flex-col items-center justify-center gap-4">
            ...
            <nav class="flex flex-col items-start justify-center w-full">
                ...
                <a href="../Models/enrutador.php?c=peticionComp" class="flex items-center justify-start px-5 gap-4 h-12 hover:bg-slate-800 w-full text-lg text-gray-50"><i class="fa-solid fa-user-ninja"></i> Competidores</a>
