...
<body class="w-full flex items-center justify-center flex-col bg-slate-950 p-4">

    <main class="w-9/12 bg-gray-50 min-h-screen rounded-lg flex items-center justify-between overflow-hidden">
        <!-- Imagen -->
        <div class="w-4/12 bg-slate-800 flex items-center justify-center" style="height: 120vh;">
            <img src="../../../../assets/img/Logotype.svg" class="w-64 " alt="">
        </div>

        <!-- Formulario -->
        <div class="w-8/12 h-full bg-gray-100 flex flex-col items-start justify-between px-4 py-8">
            ...
            <form action="" method="" class=""> 
                ...
                <div class="form__container flex flex-col gap-12 w-full">
                    ...
                    <div class="flex items-center justify-between gap-8 w-full mb-8">
