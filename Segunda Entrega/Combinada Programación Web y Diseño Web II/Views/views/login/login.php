        ...
        <form method="post" action="#"
            ...
            <div class="form__container flex items-start justify-center flex-col gap-8 relative">
                ...
                <div class="form__group relative">
                    <input type="text"
                        class="rounded-md w-full bg-transparent border outline-none py-2 px-4 text-gray-900 text-xl border-gray-950 origin-top-left translate-y-3"
                        name="username">
                    <label for="username" class="absolute top-0 left-3 cursor-pointer px-1">Usuario</label>
                </div>

                <div class="form__group relative">
                    <input type="password" class="rounded-md w-full bg-transparent border outline-none py-2 px-4 text-gray-900 text-xl border-gray-950 origin-top-left translate-y-3" name="pass" id="passwordField">
