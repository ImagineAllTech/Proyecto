...
<body class="body bg-gray-100 flex flex-col justify-center items-end w-full min-h-screen font-montserrat">
    ...
    <main class="w-full flex items-center justify-between h-screen flex-col">
            ...
            <div class="flex flex-col items-center justify-center w-10/12 gap-3">
                <h1 class="text-8xl text-center text-black font-semibold font-bricolage">Confederacion <span class="text-blue-700">Uruguaya</span> de <span class="text-blue-700">Karate</span></h1>
                <p class="font-montserrat text-2xl font-semibold text-blue-700">CUK Kata | Imagine All Tech</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-center gap-6 w-full">
                ...
                <nav class="flex items-center justify-between w-8/12 gap-4">
                        <a href="Views/views/login/login.php"
                        class="w-6/12 h-12 bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 font-semibold rounded-full text-xl">Iniciar
                        sesion</a>

                        <a href="Views/views/publico/formularios/competidor/competidor.php"
                        class="w-6/12 h-12 bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 font-semibold rounded-full text-xl ">Registrar</a>
                        
                        <a href="Views/views/publico/formularios/contacto/contacto.php"
                        class="w-6/12 h-12 bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 font-semibold rounded-full text-xl">Contacto</a>
                    
                        <a href="http://cuk.org.uy/"
                        class="w-6/12 h-12 bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 font-semibold rounded-full text-xl">Visitar
                        CUK</a>
                </nav>
